...
`MAPTILER_KEY` in browser code is a **public client token**. Restrict it by allowed domains/referrers in the MapTiler dashboard.

Set it in `composeApp/src/webMain/resources/index.html`:
```html
window.MAPTILER_KEY = "YOUR_PUBLIC_MAPTILER_KEY";
```
